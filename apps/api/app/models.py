...
class ResearchNote(Base):
    ...
    paper_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("papers.id", ondelete="SET NULL"), nullable=True, index=True)
    chunk_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("paper_chunks.id", ondelete="SET NULL"), nullable=True, index=True)
